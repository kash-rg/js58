...
# for the above, stackoverflow said to add "#!/bin/bash" but it looked commented out when I did that
...
cd ~/
cd js58/Sites
mkdir -p i/was/wondering/'if'/after/all/these/years/you\ would/like/to/meet
touch meet.jpg


chmod +x ~/Kash/js58/js-homework